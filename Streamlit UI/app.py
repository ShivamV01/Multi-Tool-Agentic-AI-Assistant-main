...
def get_agent_executor(groq_key):
    ...
    # loader = PyPDFLoader(r"C:\GitHub\Multi-Tool-Agentic-AI-Assistant-main\data\Agent Quality Whitepaper.pdf")
    # docs = loader.load()
    # documents = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=200).split_documents(docs)
    ...
    loader1 = TextLoader(r"C:\GitHub\Multi-Tool-Agentic-AI-Assistant-main\data\about_me.txt")
    docs1 = loader1.load()
    ...
    tools = [wiki, arxiv, url_retriever_tool, text_retriever_tool]
